...
export default function DekanLayout({
  ...
  const isGlobalSuperadminPage = isSuperadmin
    && (pathname === '/dekan/dekanlar' || pathname === '/dekan/yotoqxonalar'
      ...
      || pathname === '/dekan/tekshiruv' || pathname === '/dekan/tizim-elonlari'
      || pathname === '/dekan/talabalar-global')
    ...
    return [
      ...(isSuperadmin
        ? [
            ...
            { label: 'Tizim e‘lonlari', caption: 'Barcha talabaga', href: '/dekan/tizim-elonlari', icon: Megaphone },

...
import { Bell, ClipboardCheck, ClipboardList, LayoutDashboard, LogOut, Users, Wallet } from 'lucide-react'
...
const NAV = [
  ...
  { href: '/tarbiyachi/yoqlama', label: "Yo'qlama", icon: ClipboardCheck },

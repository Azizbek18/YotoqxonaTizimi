            ...
            <div className="relative overflow-hidden rounded-[28px] bg-slate-950/85 dark:bg-slate-950/90 backdrop-blur-2xl border border-white/10 p-5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] shadow-indigo-500/10">
              ...
              <div className="flex items-center gap-2 sm:gap-3 mt-4 relative z-10 pl-0 sm:pl-[72px]">
                <button
                  ...
                  className="flex-1 min-w-0 flex items-center justify-center gap-1.5 px-3 sm:px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white text-xs font-black uppercase tracking-wider active:scale-95 transition-all"
                >
          ...
          <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
            ...
            >
              ...
              <button
                ...
                className="w-full py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white text-xs font-black uppercase tracking-wider active:scale-95 transition-all"
              >
                Tushundim
              </button>
            </motion.div>

-- ==========================================================
-- apply_building_layout — ketma-ket raqamlashni BUTUN BINO bo'yicha hisoblash
-- ==========================================================
-- Ilgari 'sequential' raqamlashда `lo` (qavat boshlanish raqami) faqat
-- REJADAGI qavatlarни sanardi. Bo'lingan binoда bir fakultet o'z qavatини
-- generatsiya qilса, boshqa fakultetning pastдаги qavatlari e'tiborga
-- olinmай, raqamlash 1 dan boshlanib ketardi (3-yotoqxona 2-qavat: 1-qavatда
-- 7 raqamli xona bo'lса ham 2-qavat 8 emas, 1 dan boshlanardi).
--
-- Endi `lo` = 1 + (pastдаги HAMMA qavatlarning raqamli xona soni):
--   * rejадаги qavat  → reja soni (harfli xonalar minus),
--   * rejаsiz qavat   → hozirги raqamli xona soni.
-- Shунда har fakultet FAQAT o'z qavatларини generatsiya qilса ham, raqamlash
-- butun bino bo'yicha izchil davom etadi (2-qavat: 8–35, keyin 3-qavat: 36–…).
--
-- P0007 (begona qavat rejаda) — o'zgarmadi: fakultet faqat o'z qavatларини
-- qayta raqamlaydi. INSERT qatorlарига qavatning HAQIQIY egasi yoziladi
-- (dorm_floor.faculty), p_faculty emas — 202609300015 bilan bir xil izchillik;
-- yagona-fakultetли binoда (dorm_floor bo'sh) COALESCE p_faculty ga tushadi.
